...
//        paramsMap.put("kw","thinkpad");
//        paramsMap.put("fr","index");
//        //paramsMap.put("red_tag","t2979401838");
//        String s = doGet("http://tieba.baidu.com/f",paramsMap);
//        System.out.println(s);
        String url = "http://fanyi.baidu.com/sug";
        Map<String, String> paramsMap = new HashMap<>();
        paramsMap.put("kw","翻译");
        String s = doPost(url, paramsMap);
        System.out.println(s);
    }
